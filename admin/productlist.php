     ...
     <div class="container-fluid">
         ...
         <div class="col-md-14">
             <div class="card ">
                 ...
                 <div class="card-body">
                     <div class="col-md-2 offset-md-10"> <a class=" btn btn-primary "
                             href="index.php?page=addproduct">Add New</a></div>
                     <br>
                     <div class="table-responsive ps">
                        ...
                        <a class=' btn btn-danger btn-sm clothes_list' href='javascript:void(0)' data-id ='$product_id'>Delete</a>
...
$('.clothes_list').click(function() {

    var conf = confirm('Are you sure to delete this data?');
    if (conf == true) {
        $.ajax({
            url: 'clothes_list.php?id=' + $(this).attr('data-id'),
